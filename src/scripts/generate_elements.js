...
const labelEasy = createElement({ tag: 'label', text: 'easy', parent: levelContainer, attributes: { for: 'easy' }, classes: ['level-checked'] })
const easyLevelBtn = createElement({ tag: 'input', parent: levelContainer, attributes: { type: 'radio', id: 'easy', value: 'easy', name: 'level' }, classes: ['input__radio'] });
...
//input
const input = createElement({ tag: 'input', parent: mainContainer, classes: ['input', 'hidden'] });
input.setAttribute('readonly', '');
const buttonBox = createElement({ parent: mainContainer, classes: ['button-wrapper', 'hidden'] });
...
export const nextBtn = createElement({ tag: 'button', text: 'Next Round', parent: buttonBox, classes: ['button'] });
